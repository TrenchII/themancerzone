              ...
              <div id='carouselControl2' class='carousel slide' data-interval='0'>
                ...
                <div class='carousel-inner'>
                    <div class='carousel-item active'>
                        <div class='multislide'>
                            <div class='captionpair'>
                                <a href = 'lesson.php?lessonid=".$lessonsSoonLessonID[0] ."'><img class='cImage' src='/themancerzone/php/image.php?pfpid=".$lessonsSoonpfpID[0]."' alt='".$lessonsSoonTitle[0]."'></a>
                                <p>".$lessonsSoonTitle[0]."</p>
                            </div>
                            <div class='captionpair'>
                                <a href = 'lesson.php?lessonid=".$lessonsSoonLessonID[1] ."'><img class='cImage' src='/themancerzone/php/image.php?pfpid=".$lessonsSoonpfpID[1]."' alt='".$lessonsSoonTitle[1]."'></a>
                                <p>".$lessonsSoonTitle[1]."</p>
                            </div>
                            <div class='captionpair'>
                                <a href = 'lesson.php?lessonid=".$lessonsSoonLessonID[2] ."'><img class='cImage' src='/themancerzone/php/image.php?pfpid=".$lessonsSoonpfpID[2]."' alt='".$lessonsSoonTitle[2]."'></a>
                                <p>".$lessonsSoonTitle[2]."</p>
                            </div>
                            <div class='captionpair'>
                                <a href = 'lesson.php?lessonid=".$lessonsSoonLessonID[3] ."'><img class='cImage' src='/themancerzone/php/image.php?pfpid=".$lessonsSoonpfpID[3]."' alt='".$lessonsSoonTitle[3]."'></a>
                      ...
                      <div class='carousel-item'>
                        <div class='multislide'>
                            <div class='captionpair'>
                                <a href = 'lesson.php?lessonid=".$lessonsSoonLessonID[4] ."'><img class='cImage' src='/themancerzone/php/image.php?pfpid=".$lessonsSoonpfpID[4]."' alt='".$lessonsSoonTitle[4]."'></a>
                                <p>".$lessonsSoonTitle[4]."</p>
                            </div>
                            <div class='captionpair'>
                                <a href = 'lesson.php?lessonid=".$lessonsSoonLessonID[5] ."'><img class='cImage' src='/themancerzone/php/image.php?pfpid=".$lessonsSoonpfpID[5]."' alt='".$lessonsSoonTitle[5]."'></a>
                                <p>".$lessonsSoonTitle[5]."</p>
                            </div>
                            <div class='captionpair'>
                                <a href = 'lesson.php?lessonid=".$lessonsSoonLessonID[6] ."'><img class='cImage' src='/themancerzone/php/image.php?pfpid=".$lessonsSoonpfpID[6]."' alt='".$lessonsSoonTitle[6]."'></a>
                                <p>".$lessonsSoonTitle[6]."</p>
                            </div>
                            <div class='captionpair'>
                                <a href = 'lesson.php?lessonid=".$lessonsSoonLessonID[7] ."'><img class='cImage' src='/themancerzone/php/image.php?pfpid=".$lessonsSoonpfpID[7]."' alt='".$lessonsSoonTitle[7]."'></a>
                      ...
                      <div class='carousel-item'>
                        <div class='multislide'>
                            <div class='captionpair'>
                                <a href = 'lesson.php?lessonid=".$lessonsSoonLessonID[8] ."'><img class='cImage' src='/themancerzone/php/image.php?pfpid=".$lessonsSoonpfpID[8]."' alt='".$lessonsSoonTitle[8]."'></a>
                                <p>".$lessonsSoonTitle[8]."</p>
                            </div>
                            <div class='captionpair'>
                                <a href = 'lesson.php?lessonid=".$lessonsSoonLessonID[9] ."'><img class='cImage' src='/themancerzone/php/image.php?pfpid=".$lessonsSoonpfpID[9]."' alt='".$lessonsSoonTitle[9]."'></a>
                                <p>".$lessonsSoonTitle[9]."</p>
                            </div>
                            <div class='captionpair'>
                                <a href = 'lesson.php?lessonid=".$lessonsSoonLessonID[10] ."'><img class='cImage' src='/themancerzone/php/image.php?pfpid=".$lessonsSoonpfpID[10]."' alt='".$lessonsSoonTitle[10]."'></a>
                                <p>".$lessonsSoonTitle[10]."</p>
                            </div>
                            <div class='captionpair'>
                                <a href = 'lesson.php?lessonid=".$lessonsSoonLessonID[11] ."'><img class='cImage' src='/themancerzone/php/image.php?pfpid=".$lessonsSoonpfpID[11]."' alt='".$lessonsSoonTitle[11]."'></a>
              ...
              <div id='carouselControl3' class='carousel slide' data-interval='0''>
                ...
                <div class='carousel-inner'>
                  <div class='carousel-item active'>
                    <div class='multislide'>
                            <div class='captionpair'>
                                <a href = 'profile.php?username=".$creatorsuserName[0] ."'><img class='cImage' src='/themancerzone/php/image.php?pfpid=".$creatorspfpID[0]."' alt='".$creatorsdisplayName[0]."'></a>
                                <p>".$creatorsdisplayName[0]."</p>
                            </div>
                            <div class='captionpair'>
                                <a href = 'profile.php?username=".$creatorsuserName[1] ."'><img class='cImage' src='/themancerzone/php/image.php?pfpid=".$creatorspfpID[1]."' alt='".$creatorsdisplayName[1]."'></a>
                                <p>".$creatorsdisplayName[1]."</p>
                            </div>
                            <div class='captionpair'>
                                <a href = 'profile.php?username=".$creatorsuserName[2] ."'><img class='cImage' src='/themancerzone/php/image.php?pfpid=".$creatorspfpID[2]."' alt='".$creatorsdisplayName[2]."'></a>
                                <p>".$creatorsdisplayName[2]."</p>
                            </div>
                            <div class='captionpair'>
                                <a href = 'profile.php?username=".$creatorsuserName[3] ."'><img class='cImage' src='/themancerzone/php/image.php?pfpid=".$creatorspfpID[3]."' alt='".$creatorsdisplayName[3]."'></a>
                  ...
                  <div class='carousel-item'>
                    <div class='multislide'>
                            <div class='captionpair'>
                                <a href = 'profile.php?username=".$creatorsuserName[4] ."'><img class='cImage' src='/themancerzone/php/image.php?pfpid=".$creatorspfpID[4]."' alt='".$creatorsdisplayName[4]."'></a>
                                <p>".$creatorsdisplayName[4]."</p>
                            </div>
                            <div class='captionpair'>
                                <a href = 'profile.php?username=".$creatorsuserName[5] ."'><img class='cImage' src='/themancerzone/php/image.php?pfpid=".$creatorspfpID[5]."' alt='".$creatorsdisplayName[5]."'></a>
                                <p>".$creatorsdisplayName[5]."</p>
                            </div>
                            <div class='captionpair'>
                                <a href = 'profile.php?username=".$creatorsuserName[6] ."'><img class='cImage' src='/themancerzone/php/image.php?pfpid=".$creatorspfpID[6]."' alt='".$creatorsdisplayName[6]."'></a>
                                <p>".$creatorsdisplayName[6]."</p>
                            </div>
                            <div class='captionpair'>
                                <a href = 'profile.php?username=".$creatorsuserName[7] ."'><img class='cImage' src='/themancerzone/php/image.php?pfpid=".$creatorspfpID[7]."' alt='".$creatorsdisplayName[7]."'></a>
                  ...
                  <div class='carousel-item'>
                    <div class='multislide'>
                            <div class='captionpair'>
                                <a href = 'profile.php?username=".$creatorsuserName[8] ."'><img class='cImage' src='/themancerzone/php/image.php?pfpid=".$creatorspfpID[8]."' alt='".$creatorsdisplayName[8]."'></a>
                                <p>".$creatorsdisplayName[8]."</p>
                            </div>
                            <div class='captionpair'>
                                <a href = 'profile.php?username=".$creatorsuserName[9] ."'><img class='cImage' src='/themancerzone/php/image.php?pfpid=".$creatorspfpID[9]."' alt='".$creatorsdisplayName[9]."'></a>
                                <p>".$creatorsdisplayName[9]."</p>
                            </div>
                            <div class='captionpair'>
                                <a href = 'profile.php?username=".$creatorsuserName[10] ."'><img class='cImage' src='/themancerzone/php/image.php?pfpid=".$creatorspfpID[10]."' alt='".$creatorsdisplayName[10]."'></a>
                                <p>".$creatorsdisplayName[10]."</p>
                            </div>
                            <div class='captionpair'>
                                <a href = 'profile.php?username=".$creatorsuserName[11] ."'><img class='cImage' src='/themancerzone/php/image.php?pfpid=".$creatorspfpID[11]."' alt='".$creatorsdisplayName[11]."'></a>
